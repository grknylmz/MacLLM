...
struct ConstantsTests {
    ...
    @Test("App directory name is .mlx-manager")
    func testAppDirectoryName() {
        #expect(Constants.appDirectoryName == ".mlx-manager")
    }
    ...
    @Test("App directory URL points to home/.mlx-manager")
    func testAppDirectoryURL() {
        let home = FileManager.default.homeDirectoryForCurrentUser
        let expected = home.appendingPathComponent(".mlx-manager")
