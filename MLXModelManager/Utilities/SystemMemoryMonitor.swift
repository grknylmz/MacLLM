...
class SystemMemoryMonitor {
    ...
    private func refreshProcesses() {
        ...
        do {
            ...
            topProcesses = parseProcessList(output, mlxPID: mlxPIDVal)
        } catch {
            return
        }
    }

    private func parseProcessList(_ output: String, mlxPID: Int32?) -> [AppProcessInfo] {
    ...
    private func shouldFilterOut(_ proc: AppProcessInfo) -> Bool {
        let filteredNames = [
    ...
    private func extractProcessName(command: String) -> String {
